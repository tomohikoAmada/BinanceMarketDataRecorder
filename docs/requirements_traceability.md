...
| FAI-06 | Future exact-VPS staged acceptance is artifact-bound, reboot-sensitive, and fail-closed on evidence loss | M22.9 acceptance observer, Risk R-055 | Installed `m22.9-acceptance-evidence.v1` identity/readiness/stage chain; deterministic clock, Systemd process-incarnation, strict manifest/Catalog, no-clobber publication and resume tests; no production window started |
