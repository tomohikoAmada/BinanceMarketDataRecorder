...
| FAI-05 | A fatal bounded post-close handoff failure cannot seal the old tail complete or restart without same-gap/first-new Raw evidence | ADR-0027, Risk R-054 | Historical deployed-artifact correction and evidence remain artifact-specific; MS1 preserves the identity boundary. MS4-C qualification must recheck continuity under fan-out |
...
| FAI-07 | Startup recovery remains live and stoppable without false completion | Risk R-056, M22.9 current-state record | Current behavior/deployment source `303e073e25d5ed53d7cf6e26a9c6c6e879013b50` is installed only in the stopped MS4-B deployment; its exact identity pre-start review is complete, but recovery/readiness at startup and before T0 have no live evidence or duration. MS4-C must repeat identity pre-start checks and then prove recovery/readiness at startup and before T0 |
| VPS-01 | Ubuntu 24.04 LTS x86_64, Python 3.12, non-root systemd, shared engineering VPS | ADR-0028 | The exact artifact for current behavior/deployment source `303e073e25d5ed53d7cf6e26a9c6c6e879013b50` is frozen and installed only in the stopped MS4-B deployment. MS4-C requires separate start authorization and live qualification |
...
| CAP-04 | VPS free-byte/ETA policy: 18/14/12/10 GiB and 7d/72h/24h, protected 10 GiB reserve | ADR-0028, vps_operations, R-049 | Thresholds are unchanged. MS3-B offline evidence preserves aggregate growth, topology-decomposition invariance, global state, and the 42-identity hard-reserve stop. MS4-B stopped preflight measured a 3h envelope as PASS only (conservative 24h-rate runway about 87.819461 h); this is not live qualification. MS4-C must immediately recheck capacity, and Formal M22.9 capacity remains insufficient/unproven |
...
tree `2b30a4dd2b8c694ac2e3abad88d6cb56a75badee`; MS4-B installed it only in a
stopped deployment. Current live GitHub `main` is `bb8c93ba63c23adaf2cb0288b6ea127030b89e58`
with tree `8770f48d458dc4e35d813e8db8dc2009ff78889c`, a documentation-only
descendant and not deployed. The MS1 merge
