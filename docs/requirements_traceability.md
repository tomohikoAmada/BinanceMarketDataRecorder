...
| ARC-02 | Durable local verification, receipt binding, source revalidation, then immediate VPS deletion; one copy is not backup | ADR-0029, R-048 | Future remote transaction implementation and deletion authorization tests |
