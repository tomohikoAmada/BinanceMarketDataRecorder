...
| FAI-05 | A fatal bounded post-close handoff failure cannot seal the old tail complete or restart without same-gap/first-new Raw evidence | ADR-0027, Risk R-054 | M22.9 Spot/USD-M saturated-queue regressions plus existing R1/R2/R2.1/R2.2 crash matrix; local fix not deployed |
