...
| R-004 | Callback or writer backpressure causes silent loss/unbounded memory | Critical | M3 bounded spool plus M4 finite WebSocket buffer/receipt queue; overflow raises a critical collector fault, never drops silently; USD-M remains M5 | M3-M5 | Monitoring |
...
| R-006 | Spot or USD-M sequence semantics are applied to the other market | Critical | M4 isolates official Spot fixtures and `U/u`; USD-M `U/u/pu` remains a separately gated M5/M6 implementation | M4-M6 | Monitoring |
