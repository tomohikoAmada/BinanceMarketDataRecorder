...
| R-036 | USD-M 5m limited-retention polls are missed while the recorder is offline | High | Independent retry/status, explicit missing periods, latest-closed polling, no zero/forward-fill; complete long-run operation before relying on continuity | M19 | Open |
