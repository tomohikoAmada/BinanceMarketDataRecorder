...
## M2 resolution policy

Pydantic retains a compatible major-version range. The generated official SDKs
and `websockets` are exact-pinned because their concrete APIs and internals are
the subject of M2 evidence. The complete certified macOS arm64/Python 3.12
